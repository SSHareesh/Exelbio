  ...
  return (
    <section className="min-h-[70vh] flex items-center justify-center bg-paper">
      <div className="text-center px-6">
        <p className="font-mono text-sm text-teal font-bold">404</p>
        <h1 className="mt-4 font-display text-3xl text-primary font-bold">This page didn't make it into the dataset.</h1>
